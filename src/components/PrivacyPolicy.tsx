...
export const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ onBack }) => {
  return (
    <div className="min-h-screen bg-slate-900 text-slate-300 p-4 font-sans selection:bg-indigo-500/30">
      <div className="max-w-3xl mx-auto bg-slate-800 rounded-xl shadow-2xl overflow-hidden border border-slate-700">

        <div className="p-6 border-b border-slate-700 bg-slate-800/50 sticky top-0 backdrop-blur-sm z-10 flex items-center justify-between">
        ...
        <div className="p-8 space-y-8 text-slate-300 leading-relaxed text-sm md:text-base">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">1. Data Collected and Collection Methods</h2>
            ...
            <p className="mt-4 text-indigo-300 font-medium">Klatana DOES NOT collect:</p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">2. Purpose of Processing</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">5. Cookies and Similar Technologies</h2>
            <p>
